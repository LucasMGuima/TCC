...
O uso de ferramentas computacionais é uma realidade no dia a dia, e a integração de computadores nas 
mais diversas áreas é um modo de gerar um impulso na capacidade de produção em várias 
escalas \cite{comp_conceitosAplicacoes}.
...
hospedeiro, como indicado por Cosme. Logo mesmo com a facilidade de se adquirir um computador, o acesso a maquinas com maior capacidade
...
dá coleta dos dados, treino e validação do modelo, e análise dos resultados obtidos.
