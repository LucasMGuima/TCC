...
\begin{itemize}
  \item Python texto
  \item R texto
  \item Streamlit texto
  \item Supabase texto
  \item subprocess texto
\end{itemize}
...
Sobre os dados, de onde vieram, e como devem ser cuidados.

\subsection{Armazenamento}

\section{Implementação}

\subsection{Treinando um modelo}

\subsection{Avaliando o modelo}
