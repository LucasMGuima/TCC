...
é o parametro de dispersão, qundo se espera um $\phi$ seja maior que que o valor antecipado dado a distribuição escolida, o parametro de
...
Se assumirmos $x$ sendo um valor inteiro, que é $wn$ é impart, então a span $w$ vizinhança mais próxima simétrica conterá
...
controla a suavidade dos resultados estimados, e geralmente é escolhido com base nos dadis a serem usados \cite{GAM}. Se
