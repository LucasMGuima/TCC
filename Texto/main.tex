...
Para os modelos feitos com o GLM.
\begin{figure}[H]
    \centering
    \caption{\label{fig:diagrama_sequencia_glm} Diagrama de Sequência - GLM}
    \includegraphics[width=0.50\textwidth]{../modelagens/glm.png}
    \legend{Fonte: Elaboração do autor}
\end{figure}

Para os modelos feitos com o GAM.
\begin{figure}[H]
    \centering
    \caption{\label{fig:diagrama_sequencia_gam} Diagrama de Sequência - GAM}
    \includegraphics[width=0.50\textwidth]{../modelagens/gam.png}
    \legend{Fonte: Elaboração do autor}
\end{figure}

E para os modelos feitos com o MARS.
\begin{figure}[H]
    \centering
    \caption{\label{fig:diagrama_sequencia_mars} Diagrama de Sequência - MARS}
    \includegraphics[width=0.50\textwidth]{../modelagens/mars.png}
    \legend{Fonte: Elaboração do autor}
\end{figure}
...
Como a arquitetura apresentada foi implementada em código.

\subsection{Modelos}

Como os modelos são gerados, e oque os mesmo geram como arquivos auxiliares.
...
Durante o treino do modelo, os dados são separdos em dois conjunto, um pra o trieno em si e o segundo para os testes posteriores, se estes
dados já não tiverem sido separados durante a criação de outros modelo. Ao terminar de criar o modelo, a aplicação gera um arquivo 
\textit{JSON} contendo os dados do modelo, como apresentado a baixo.

\lstset{style=r_code} % CRIAR ESTILO PARA JSON %
\begin{lstlisting}
[
  {
...
Como o sistema lida com o treinamento dos modelos, o armazenamento e pos utilização.

\subsubsection{Avaliação}

Como o sistema faz para avaliar o modelo de modo coerente com base no tipo de dado
que está sento trabalhado.
