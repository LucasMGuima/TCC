...
Tanto para os modelos disponíveis quanto para os dados, o sistema possue a capacidade de armazenar os mesmo em um serviço armazenamento
...
Uma breve explicação dos recursos e tecnologias utilizadas no projeto, e suas versões.
\begin{itemize}
...
Os tipos de dados suportados pelo sistema.

\subsection{Preparo}

Como esses dados devem ser preparados para serem inseridos no programa.

\subsection{Armazenamento}

Como e onde esses dados são armazenados, quando estão dentro do sistema.
E como o sistema lida com a perca da internet
