...
Generalized Linear Model (GLM) \cite{GLM}, e o Multivariate Adaptive Regression Spline (MARS) 
\cite{MARS}, ambos com uma abordagem de Maximum likelihood (ML) \cite{predPerform33models}. 
Onde as implementações mais utilizadas destes são encontradas nas bibliotecas da linguagem 
