...
Possuimos uma boa quantidade de trabalhos onde os autores comparam e avaliam tipos de modelos de distribuição de espécies, como
em \cite{predPerform33models} que avalia a performance de 33 modelos.

Neste temos uma dicecação das caraceristicas destes modelos quais caraceristicas cada modelo possue, e o tipo de dado que os 
mesmo trabalham com, sendo dados de presensa, ausência ou ambos, e como ele relaciona a especie com seu ambiente e avalia os
modelos levando em consideração especies comuns e raras como dois grupos distintos.

Temos uma avaliação do impacto do tamanho do conjunto de dados na performance do modelo dentro do trabalho \cite{sampleSize},
em um conjunto menor de modelos doque os trabalhos anteriores, mas ainda relevante, demonstrando como cada tipo de modelo
atua com tamanhos diferentes de dados.

Mas não temos uma demonstração do tempo que cada modelo leva para ser preparado, ou a quantidade de memória do computador
que os modelos utilizam. 
