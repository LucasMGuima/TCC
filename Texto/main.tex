...
O uso de ferramentas computacionais é uma realidade nos dias atuais, e a integração de
computadores nas mais diversas áreas é um modo de gerar um impulso na capacidade de
produção em várias escalas.
Os modelos estatísticos são uma daessas ferramentas, possuindo uma vasta área de aplicação
(sitação), e a Biologia não fica de fora, aqui eles podem ser aplicados como modelos de distribuição
de especies, onde são capazes de nos fornecer uma visualização da situação da fauna e flora e
determinada região, podendo mostrar como estes estão se comportando no decorrer do tempo.
